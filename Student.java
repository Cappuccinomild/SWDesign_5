...
public class Student extends User{
	...
	public void setExam() {
		String sql = "select cnumber, cname, pnum, csdate, cfdate, cday, course_room, esdate, efdate, eday, exam_room from take_class, classhour, course, exam where conum = cnumber and cno = cnumber and cnum = cnumber and snum = '"+this.ID+"'";
		ResultSet rs;
