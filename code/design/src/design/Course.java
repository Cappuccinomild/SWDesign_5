...
public class Course {
	...
	String lecture_code, lecture_name, professor_info, lecture_stime, lecture_ftime, lecture_date, lecture_room,
			building_number;

	public Course(String lecture_code, String lecture_name, String professor_info, String lecture_stime,
			String lecture_ftime, String lecture_date, String lecture_room) {
	...
	public String getCourse() {
		return lecture_name + "\t" + professor_info + "\t" + lecture_room + "\t" + lecture_stime + "\t" + lecture_ftime
				+ "\t" + lecture_date;
	}
